...
To-Do :
	...
	- Elegante Modulare Lösung finden um Atacken auszuführen
		Idee : Neuen Datentypen einrichten BitReihe (000101100) 
			   In der Attackenausführung alle Bits durchshiften 
			   if((param>>0&0x01)==1) schaden
			   if((param>>1&0x01)==1) apply burn
